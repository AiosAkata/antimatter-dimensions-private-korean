...
export const eternityUpgrades = {
  idMultEP: {
    id: 1,
    cost: 5,
    description: () => `미사용 영원 포인트를 기반으로 한 무한 차원 배율 (x+${formatInt(1)})`,
  ...
  idMultEternities: {
    id: 2,
    cost: 10,
    description: () => `영원을 기반으로 한 무한 차원 배율
      ((x/${formatInt(200)})^log4(${formatInt(2)}x), 소프트캡: ${format(1e5)} 영원)`,
    effect() {
  ...
  idMultICRecords: {
    id: 3,
    cost: 5e4,
    description: "무한 도전 시간의 합을 기반으로 한 무한 차원 배율",
  ...
  tdMultAchs: {
    id: 4,
    cost: 1e16,
    description: "당신의 업적 보너스가 시간 차원에 영향을 줍니다",
  ...
  tdMultTheorems: {
    id: 5,
    cost: 1e40,
    description: "시간 차원이 미사용 시간 정리에 의해 배수됩니다",
  ...
  tdMultRealTime: {
    ...
    description: () => (Pelle.isDoomed
      ? "시간 차원이 이 종말론에서 플레이한 일수에 의해 배수됩니다"
      : "시간 차원이 플레이한 일수에 의해 배수됩니다"
    ),
